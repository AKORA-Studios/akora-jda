...
public class ConfigurationInterface extends Module {

    public ConfigurationInterface() {
        super("Konfiguration", new ArrayList<String>(Arrays.asList(new String[]{"config", "conf"})),
                "config [set|get] [msg|ch] {Value}", "Zum konfigurieren der Welcome- und Goodbyemessage und der Autorole" +
                        "`$DISPLAY$` - Der Name der angezeigt wird" +
                        "`$USER$` - Der Nutzername" +
                        "`$MENTION$` - Erwähnung" +
